...
<head>
    ...
    <style>
        ...
        /* --- Ajout minimal pour la validation en direct : ne modifie aucune disposition existante --- */
        .flex-form { position: relative; } /* nécessaire pour positionner les bulles d'erreur en absolu */
